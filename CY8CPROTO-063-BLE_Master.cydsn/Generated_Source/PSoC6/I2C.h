...
#define I2C_EnableInt()        				__NVIC_EnableIRQ      (I2C_ISR_NUMBER)
#define I2C_DisableInt()       				__NVIC_DisableIRQ     (I2C_ISR_NUMBER)
#define I2C_ClearPendingInt()  				__NVIC_ClearPendingIRQ(I2C_ISR_NUMBER)
#define I2C_SetPendingInt()    				__NVIC_SetPendingIRQ  (I2C_ISR_NUMBER)
...
#if(I2C_I2C_IRQ_INTC_CORTEXM4_ASSIGNED)
#define I2C_ISR_PRIORITY   ((uint8) I2C_I2C_IRQ__INTC_CORTEXM4_PRIORITY)
#else
#define I2C_ISR_PRIORITY   ((uint8) I2C_I2C_IRQ__INTC_CORTEXM0P_PRIORITY)
#endif	
...
#define I2C_ENABLE     (1u)
    ...
    #define I2C_DEFAULT_DIVIDE_FACTOR  ((uint16) 11u)
