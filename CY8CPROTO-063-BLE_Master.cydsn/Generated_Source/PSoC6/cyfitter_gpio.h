...
/* OVERFLOW */
#define OVERFLOW_0_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define OVERFLOW_0_INBUF_ENABLED 0u
#define OVERFLOW_0_INIT_DRIVESTATE 1u
#define OVERFLOW_0_INIT_MUXSEL 3u
#define OVERFLOW_0_INPUT_SYNC 2u
#define OVERFLOW_0_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define OVERFLOW_0_NUM 0u
#define OVERFLOW_0_PORT GPIO_PRT0
#define OVERFLOW_0_SLEWRATE CY_GPIO_SLEW_FAST
#define OVERFLOW_0_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define OVERFLOW_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define OVERFLOW_INBUF_ENABLED 0u
#define OVERFLOW_INIT_DRIVESTATE 1u
#define OVERFLOW_INIT_MUXSEL 3u
#define OVERFLOW_INPUT_SYNC 2u
#define OVERFLOW_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define OVERFLOW_NUM 0u
#define OVERFLOW_PORT GPIO_PRT0
#define OVERFLOW_SLEWRATE CY_GPIO_SLEW_FAST
#define OVERFLOW_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
