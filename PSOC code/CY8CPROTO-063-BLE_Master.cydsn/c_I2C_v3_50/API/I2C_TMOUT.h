...
uint16 `$INSTANCE_NAME`_TimeoutGetPeriod(void)          `=ReentrantKeil($INSTANCE_NAME . "_TimeoutGetPeriod")`;
    ...
    void  `$INSTANCE_NAME`_TimeoutSetPrescalerPeriod(uint8_t period)
                                                        `=ReentrantKeil($INSTANCE_NAME . "_TimeoutSetPrescalerPeriod")`;
    uint8_t `$INSTANCE_NAME`_TimeoutGetPrescalerPeriod(void)
    ...
    #define `$INSTANCE_NAME`_TimeoutEnableInt() \
            do{                                 \
                `$INSTANCE_NAME`_TMOUT_CSR_REG |= (uint8_t)  `$INSTANCE_NAME`_TMOUT_CSR_I2C_TMOUT_IE; \
            }while(0)
...
***************************************/
    ...
    #define `$INSTANCE_NAME`_TMOUT_CSR_SDA_PIN_STS  ((uint8_t) (0x01u << `$INSTANCE_NAME`_TMOUT_CSR_SDA_PIN_POS))
    #define `$INSTANCE_NAME`_TMOUT_CSR_SCL_PIN_STS  ((uint8_t) (0x01u << `$INSTANCE_NAME`_TMOUT_CSR_SCL_PIN_POS))
    #define `$INSTANCE_NAME`_TMOUT_CSR_I2C_TMOUT_IE ((uint8_t) (0x01u << `$INSTANCE_NAME`_TMOUT_CSR_I2C_TMOUT_IE_POS))
    #define `$INSTANCE_NAME`_TMOUT_CSR_SDA_TMOUT_IE ((uint8_t) (0x01u << `$INSTANCE_NAME`_TMOUT_CSR_SDA_TMOUT_IE_POS))
    #define `$INSTANCE_NAME`_TMOUT_CSR_SCL_TMOUT_IE ((uint8_t) (0x01u << `$INSTANCE_NAME`_TMOUT_CSR_SCL_TMOUT_IE_POS))
    #define `$INSTANCE_NAME`_TMOUT_CSR_INTR_MASK    ((uint8_t) (0x03u << `$INSTANCE_NAME`_TMOUT_CSR_SCL_TMOUT_IE_POS))
    ...
    #define `$INSTANCE_NAME`_TMOUT_SR_SDA_PIN_TMOUT ((uint8_t) (0x01u << `$INSTANCE_NAME`_TMOUT_SR_SDA_PIN_TMOUT_STS_POS))
    #define `$INSTANCE_NAME`_TMOUT_SR_SCL_PIN_TMOUT ((uint8_t) (0x01u << `$INSTANCE_NAME`_TMOUT_SR_SCL_PIN_TMOUT_STS_POS))
    #define `$INSTANCE_NAME`_TMOUT_SR_PINS_TMOUT_MASK   ((uint8_t) (0x03u << `$INSTANCE_NAME`_TMOUT_SR_SCL_PIN_TMOUT_POS))
    ...
    /* Interrupt setup */
    #define `$INSTANCE_NAME`_TMOUT_ISR_NUMBER   ((uint8_t) `$INSTANCE_NAME`_I2C_TMOUT__INTC_NUMBER)
    #define `$INSTANCE_NAME`_TMOUT_ISR_PRIORITY ((uint8_t) `$INSTANCE_NAME`_I2C_TMOUT__INTC_PRIOR_NUM)

    /* Timeout STATUS register constants */
    #define `$INSTANCE_NAME`_TMOUT_CTRL_ENABLE_POS  (0u)
    #define `$INSTANCE_NAME`_TMOUT_CTRL_ENABLE      ((uint8_t) (0x01u << `$INSTANCE_NAME`_TMOUT_CTRL_ENABLE_POS))
    ...
    #define `$INSTANCE_NAME`_TMOUT_STS_SCL_PINS     ((uint8_t) (0x01u << `$INSTANCE_NAME`_TMOUT_STS_SDA_PIN_POS))
    #define `$INSTANCE_NAME`_TMOUT_STS_SDA_PIN      ((uint8_t) (0x01u << `$INSTANCE_NAME`_TMOUT_STS_SCL_PIN_POS))
    #define `$INSTANCE_NAME`_TMOUT_STS_SCL_INTR     ((uint8_t) (0x01u << `$INSTANCE_NAME`_TMOUT_STS_SDA_INTR_POS))
    #define `$INSTANCE_NAME`_TMOUT_STS_SDA_INTR     ((uint8_t) (0x01u << `$INSTANCE_NAME`_TMOUT_STS_SCL_INTR_POS))
    #define `$INSTANCE_NAME`_TMOUT_STS_INTR_MASK    ((uint8_t) (0x03u << `$INSTANCE_NAME`_TMOUT_STS_SCL_INTR_POS))
...
#define `$INSTANCE_NAME`_DEFAULT_TMOUT_INTR_MASK        ((uint8_t) (`$INSTANCE_NAME`_TIMEOUT_SDA_TMOUT_ENABLE << 1u) | \
